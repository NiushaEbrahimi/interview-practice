...
export default function DemoBanner() {
  ...
  return (
    <div className="fixed top-13 sm:top-1 left-1 text-center p-0 text-xs font-light flex">
      <button className={`px-2 py-1 sm:px-4 sm:py-3 rounded-2xl cursor-pointer shadow text-white bg-black dark:bg-white dark:text-black hover:dark:bg-gray-400 hover:bg-gray-800 ${style.demoBadge}`} onClick={() => toggle()}>
        Demo
      </button>
