...
export default function Header({username} : {username : string}){
  ...
  return(
      <header className="h-16 bg-white border-b flex items-center justify-between px-4 sm:px-6">
        ...
        >
          <span className={`block w-5 h-0.5 bg-gray-700 transition-transform ${menuOpen ? "rotate-45 translate-y-1.5" : ""}`}/>
        ...
        {menuOpen && (
          <div className="absolute top-16 left-0 right-0 bg-white border-b shadow-lg sm:hidden z-50">
